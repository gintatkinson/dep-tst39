...
export interface GeodeticSystem {
  ...
  'coord-accuracy'?: number;
  'height-accuracy'?: number;
}
...
export interface ReferenceFrame {
  ...
  'alternate-system'?: string;
  'astronomical-body'?: string;
  'geodetic-system'?: GeodeticSystem;
}
...
export const SCHEMA_CONTAINERS = {
